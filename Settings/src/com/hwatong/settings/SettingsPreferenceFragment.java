...
public class SettingsPreferenceFragment extends PreferenceFragment implements DialogCreatable {
	...
	private OnWifiFragmentImageChangedListener listener;
	 ...
	 *
	 */
	public interface OnWifiFragmentImageChangedListener {
		/**
		 * 
		 * @param fragmentName
		 * send current fragment's class name
		 */
		void onWifiFragmentChanged(String fragmentName);
	}
	
	public void setOnFragmentImageChangedListener(OnWifiFragmentImageChangedListener l) {
		this.listener = l;
	}
	
	public void changedActivityImage(String name) {
		if(listener != null)
			listener.onWifiFragmentChanged(name);
	}
