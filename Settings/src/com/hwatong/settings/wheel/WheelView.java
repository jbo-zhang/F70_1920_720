...
package com.hwatong.settings.wheel;
...
//	private static final int[] SHADOWS_COLORS = new int[] { 0x00ff0000,
...
//	private GradientDrawable bottomShadow;
	...
	/**
	 * forbiden to scroll or not
	 */
	public void setIsScrolled(boolean isEnabled) {
		this.isEnabled = isEnabled;
		invalidate();
	}
	
	public void setTextEnabled(boolean isEnabled) {
		this.isTextEnabled = isEnabled;
		invalidate();
	}
	...
	private void initResourcesIfNecessary() {
		LogUtils.d("initResourcesIfNecessary");
		TEXT_SIZE = (int)getResources().getDimension(R.dimen.time_setting_text_size);
		if (itemsPaint == null) {
...
//	}
	...
	private void drawValue(Canvas canvas) {
		LogUtils.d("drawValue itemsPaint color: " + itemsPaint.getColor() + ", valuePaint color: " + valuePaint.getColor());
		valuePaint.setColor(isTextEnabled ? VALUE_TEXT_COLOR : 0xff808080);
...
//		LogUtils.d("drawItems itemsPaint color: " + itemsPaint.getColor() + ", valuePaint color: " + valuePaint.getColor());
//		canvas.save();
//		
...
//		for(int i = 0; i < itemsPaint.drawableState.length; ++i)
//			LogUtils.d("drawItems getDrawableState: " + getDrawableState());
...
//		centerDrawable.draw(canvas);
	...
	private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
			...
			int maxY = isCyclic ? 0x00FFFFFF : adapter.getItemsCount() * getItemHeight();
