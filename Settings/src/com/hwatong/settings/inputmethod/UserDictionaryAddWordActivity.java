...
public class UserDictionaryAddWordActivity extends Activity {
    ...
    public static final String MODE_EDIT_ACTION = "com.hwatong.settings.USER_DICTIONARY_EDIT";
    public static final String MODE_INSERT_ACTION = "com.hwatong.settings.USER_DICTIONARY_INSERT";
