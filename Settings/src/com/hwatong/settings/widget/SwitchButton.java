...
public class SwitchButton extends CompoundButton implements OnClickListener{
    public static final float DEFAULT_BACK_MEASURE_RATIO = 1.8f;
    public static final int DEFAULT_THUMB_SIZE_DP = 20;
    public static final int DEFAULT_THUMB_MARGIN_DP = 1;
    public static final int DEFAULT_TEXT_MARGIN_DP = 1;
    ...
    private static int[] UNENABLED_STATE = new int[]{android.R.attr.state_enabled};
    private static int[] ENABLED_STATE = new int[]{-android.R.attr.state_enabled};
    ...
    private boolean isNoNeedAutoFeedback = false;
    private OnUserCheckedChangeListener onUserCheckedChangeListener;
    
    public OnUserCheckedChangeListener getOnUserCheckedChangeListener() {
		return onUserCheckedChangeListener;
	}

	public void setOnUserCheckedChangeListener(
	...
	public interface OnUserCheckedChangeListener {
    	void onUserCheckedChanged(CompoundButton buttonView, boolean isChecked);
    }

    public boolean isNoNeedAutoFeedback() {
		return isNoNeedAutoFeedback;
	}

	public void setNoNeedAutoFeedback(boolean isNeedAutoFeedback) {
		this.isNoNeedAutoFeedback = isNeedAutoFeedback;
	}
...
//            }
    ...
    protected void drawableStateChanged() {
        ...
        LogUtils.d("drawableStateChanged");
        if (!mIsThumbUseDrawable && mThumbColor != null) {
        ...
        int[] enabledState = isEnabled() ? UNENABLED_STATE : ENABLED_STATE;
        ...
        if(textColors != null) {
        	int defaultTextColor = textColors.getDefaultColor();
            mOnTextColor = textColors.getColorForState(enabledState, defaultTextColor);
            mOffTextColor = textColors.getColorForState(enabledState, defaultTextColor);
        }
        if (!mIsBackUseDrawable && mBackColor != null) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(isNoNeedAutoFeedback() && onUserCheckedChangeListener != null) {
