...
public class Utils {
     ...
     */
    private static final String META_DATA_PREFERENCE_ICON = "com.hwatong.settings.icon";

    /**
     * Name of the meta-data item that should be set in the AndroidManifest.xml
     * to specify the title that should be displayed for the preference.
     */
    private static final String META_DATA_PREFERENCE_TITLE = "com.hwatong.settings.title";

    /**
     * Name of the meta-data item that should be set in the AndroidManifest.xml
     * to specify the summary text that should be displayed for the preference.
     */
    private static final String META_DATA_PREFERENCE_SUMMARY = "com.hwatong.settings.summary";
	...
	public static String getBuildID() {
		if (Build.ID.length()>11)
			return Build.ID.substring(0,10) + ((getNumCores()==4)?"H":"D")+Build.ID.substring(11);
		else
			return Build.ID;
	}
}
