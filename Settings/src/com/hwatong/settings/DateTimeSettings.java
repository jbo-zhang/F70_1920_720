...
//	private Preference mTimePref;
	...
	private void initUI() {
		...
		mDateTimePref = findPreference("datetime");
...
//		mDatePref = findPreference("date");
		...
		mDateTimePref.setEnabled(!autoTimeEnabled);
...
//		mDatePref.setSummary(shortDateFormat.format(now.getTime()));
	...
	public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
		...
		if (key.equals(KEY_DATE_FORMAT)) {
			...
			Utils.putCarSettingsString(getContentResolver(), "auto_time", autoEnabled ? "1" : "0");
			//            Settings.Global.putInt(getContentResolver(), Settings.Global.AUTO_TIME,
			//                    autoEnabled ? 1 : 0);
			mDateTimePref.setEnabled(!autoEnabled);
...
//			mDatePref.setEnabled(!autoEnabled);
			...
			set24Hour(((SwitchPreference)mTime24Pref).isChecked());
			updateTimeAndDateDisplay(getActivity());
			timeUpdated();
		}
	}
