...
public class SoundReceiver extends BroadcastReceiver{
	...
	private static final String OPEN_FM = "com.hwatong.voice.OPEN_FM";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(OPEN_AM.equals(intent.getAction()) || OPEN_FM.equals(intent.getAction())) {
			Intent activityIntent = new Intent(context, Radio.class);
			activityIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
			int type = OPEN_AM.equals(intent.getAction()) ? 1 : 0;
